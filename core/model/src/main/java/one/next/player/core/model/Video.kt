...
data class Video(
    ...
    companion object {
        val sample = Video(
            ...
            parentPath = "/storage/emulated/0/Movies/Sample",
            uriString = "",
...
fun List<Video>.recentPlayed(): Video? = filter { it.lastPlayedAt != null }.sortedByDescending { it.lastPlayedAt?.time }.firstOrNull()
